    ...
    <form action="{{ route('payments.store') }}" method="post" class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input id="transaction_date" type="date" name="transaction_date" class="form-input" />
            </div>
            <div>
            <label for="reference_id">Reference ID</label>
            <input id="reference_id" type="text" name="reference_id" placeholder="Reference ID" class="form-input" />
            </div>
        </div>
