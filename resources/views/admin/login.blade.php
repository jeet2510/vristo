            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Sign in Admin</h1>
                        ...
                        <form class="space-y-5 dark:text-white" method="POST" action="/login">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Email" type="email" placeholder="Enter Email" name="email" class="form-input ps-10 placeholder:text-white-dark" />
