...
Route::get('/subscription_plans', [SubscriptionPlanController::class, 'show'])->name('subscription_plans.show');
...
Route::get('/subscription_plans/edit/', [SubscriptionPlanController::class, 'edit'])->name('subscription_plans.edit');
Route::post('/admin-subscription_plans/update/', [SubscriptionPlanController::class, 'update'])->name('subscription_plans.update');

Route::get('/admin-subscription', [AdminSubscriptionController::class, 'show'])->name('admin-subscription.show');
Route::get('/admin-subscription/create', [AdminSubscriptionController::class, 'showAssignSubscriptionForm'])->name('admin_subscription.show_assign_form');
Route::post('/admin-subscription/store', [AdminSubscriptionController::class, 'assignSubscription'])->name('admin_subscription.assign');
Route::get('/admin-subscription/edit/', [AdminSubscriptionController::class, 'edit'])->name('admin_subscription.edit');
Route::post('/admin-subscription/update/', [AdminSubscriptionController::class, 'update'])->name('admin_subscription.update');
Route::get('/fillter_admin_sub', [AdminSubscriptionController::class, 'fillter'])->name('admin_subscription.fillter');
...
Route::post('/fetchplan',[AdminSubscriptionController::class,'fetchplan']);
